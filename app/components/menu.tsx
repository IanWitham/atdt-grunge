    ...
    <menu className="absolute z-40 flex flex-row items-center gap-2 top-4 left-4 md:left-auto md:right-4">
      ...
      >
        ...
        <svg
          ...
          className="absolute top-0 left-0 w-5 h-5 transition-opacity duration-500 opacity-0 text-slate-900 dark:text-white dark:opacity-40 dark:group-hover:opacity-100"
          viewBox="0 0 20 20"
          fill="currentColor"
        >
          <path
        ...
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="absolute top-0 left-0 w-5 h-5 transition-opacity duration-500 text-slate-900 opacity-40 hover:opacity-100 dark:text-white dark:opacity-0 hover:dark:opacity-0"
          viewBox="0 0 20 20"
          fill="currentColor"
        >
      ...
      <a title="Find us on Twitter" href="https://twitter.com/drivethrupod">
        <svg
          ...
          height="20"
          fill="currentColor"
          className="transition-opacity duration-500 text-slate-900 opacity-40 hover:opacity-100 dark:text-white"
        >
      ...
      <a title="Find us on Facebook" href="https://facebook.com/drivethrupod">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
          className="w-5 h-5 transition-opacity duration-500 text-slate-900 opacity-40 hover:opacity-100 dark:text-white"
          viewBox="0 0 512 512"
        >
      ...
      <Link
        className="text-lg transition-opacity duration-500 font-inter text-slate-900 opacity-40 hover:opacity-100 dark:text-white"
        to="/about"
      >
        About
      </Link>
